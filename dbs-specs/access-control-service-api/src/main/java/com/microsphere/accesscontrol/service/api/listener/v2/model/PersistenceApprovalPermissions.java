...
import com.microsphere.accesscontrol.service.api.listener.v2.model.PersistenceApprovalPermissionsAllOf;
import com.microsphere.accesscontrol.service.api.listener.v2.model.PersistenceApprovalPermissionsGetResponseBody;
 ...
 */
@JsonPropertyOrder({
  PersistenceApprovalPermissions.JSON_PROPERTY_ADDITIONS,
  PersistenceApprovalPermissions.JSON_PROPERTY_APPROVAL_ID,
  PersistenceApprovalPermissions.JSON_PROPERTY_ITEMS
})
...
public  class PersistenceApprovalPermissions {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additions, approvalId, items);
  }
