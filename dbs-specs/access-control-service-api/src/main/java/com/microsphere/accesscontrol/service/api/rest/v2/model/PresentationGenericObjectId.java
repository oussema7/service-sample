...
public class PresentationGenericObjectId 
 {
    @JsonProperty("id")
    private @Pattern(regexp="^[0-9a-f]{32}$|^[0-9a-f-]{36}$")  String id;


    public PresentationGenericObjectId id(String id) {
        this.id = id;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PresentationGenericObjectId presentationGenericObjectId = (PresentationGenericObjectId) o;
        return Objects.equals(this.id, presentationGenericObjectId.id);
    }
    ...
    public String toString() {
        ...
        sb.append("class PresentationGenericObjectId {\n");
