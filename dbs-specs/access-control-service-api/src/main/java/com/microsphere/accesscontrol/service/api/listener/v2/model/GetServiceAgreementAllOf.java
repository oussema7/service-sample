 ...
 */
@JsonPropertyOrder({
  GetServiceAgreementAllOf.JSON_PROPERTY_ID,
  GetServiceAgreementAllOf.JSON_PROPERTY_EXTERNAL_ID,
  GetServiceAgreementAllOf.JSON_PROPERTY_NAME,
  GetServiceAgreementAllOf.JSON_PROPERTY_DESCRIPTION,
  GetServiceAgreementAllOf.JSON_PROPERTY_CREATOR_LEGAL_ENTITY,
  GetServiceAgreementAllOf.JSON_PROPERTY_IS_MASTER,
  GetServiceAgreementAllOf.JSON_PROPERTY_STATUS,
  GetServiceAgreementAllOf.JSON_PROPERTY_VALID_FROM_DATE,
  GetServiceAgreementAllOf.JSON_PROPERTY_VALID_FROM_TIME,
  GetServiceAgreementAllOf.JSON_PROPERTY_VALID_UNTIL_DATE,
  GetServiceAgreementAllOf.JSON_PROPERTY_VALID_UNTIL_TIME
})
...
public  class GetServiceAgreementAllOf {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, externalId, name, description, creatorLegalEntity, isMaster, status, validFromDate, validFromTime, validUntilDate, validUntilTime);
  }
