...
import com.microsphere.accesscontrol.service.api.listener.v2.model.DataItemIds;
 ...
 */
@JsonPropertyOrder({
  DataItemsPermissions.JSON_PROPERTY_FUNCTION_NAME,
  DataItemsPermissions.JSON_PROPERTY_PRIVILEGE,
  DataItemsPermissions.JSON_PROPERTY_DATA_ITEMS
})
...
public  class DataItemsPermissions {
 ...
 @Size(min=1)  @ApiModelProperty(required = true, value = "")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(functionName, privilege, dataItems);
  }
