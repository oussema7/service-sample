 ...
 */
@JsonPropertyOrder({
  ServiceAgreementUsersGetResponseBody.JSON_PROPERTY_ID,
  ServiceAgreementUsersGetResponseBody.JSON_PROPERTY_EXTERNAL_ID,
  ServiceAgreementUsersGetResponseBody.JSON_PROPERTY_LEGAL_ENTITY_ID,
  ServiceAgreementUsersGetResponseBody.JSON_PROPERTY_FULL_NAME,
  ServiceAgreementUsersGetResponseBody.JSON_PROPERTY_LEGAL_ENTITY_NAME
})
...
public  class ServiceAgreementUsersGetResponseBody {
 ...
 @Size(min=1,max=128)  @ApiModelProperty(value = "")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, externalId, legalEntityId, fullName, legalEntityName);
  }
