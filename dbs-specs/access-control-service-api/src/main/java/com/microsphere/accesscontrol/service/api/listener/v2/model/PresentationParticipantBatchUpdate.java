...
import com.microsphere.accesscontrol.service.api.listener.v2.model.PresentationParticipantPutBody;
 ...
 */
@JsonPropertyOrder({
  PresentationParticipantBatchUpdate.JSON_PROPERTY_PARTICIPANTS
})
...
public  class PresentationParticipantBatchUpdate {
  ...
  **/
  ...
  @Valid
 @Size(min=1,max=200)  @ApiModelProperty(value = "")
