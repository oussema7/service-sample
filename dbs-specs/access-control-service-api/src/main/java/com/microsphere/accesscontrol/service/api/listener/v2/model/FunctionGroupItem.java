...
import com.microsphere.accesscontrol.service.api.listener.v2.model.FunctionGroupItemAllOf;
...
@JsonPropertyOrder({
  FunctionGroupItem.JSON_PROPERTY_ADDITIONS,
  FunctionGroupItem.JSON_PROPERTY_ID,
  FunctionGroupItem.JSON_PROPERTY_SERVICE_AGREEMENT_ID,
  FunctionGroupItem.JSON_PROPERTY_NAME,
  FunctionGroupItem.JSON_PROPERTY_DESCRIPTION,
  FunctionGroupItem.JSON_PROPERTY_TYPE,
  FunctionGroupItem.JSON_PROPERTY_PERMISSIONS,
  FunctionGroupItem.JSON_PROPERTY_VALID_FROM,
  FunctionGroupItem.JSON_PROPERTY_VALID_UNTIL,
  FunctionGroupItem.JSON_PROPERTY_APPROVAL_ID,
  FunctionGroupItem.JSON_PROPERTY_METADATA
})
...
public  class FunctionGroupItem {
 ...
 @Size(min=0,max=10)  @ApiModelProperty(value = "Metadata for specific entities. Do not use it for custom extensions. Use additions instead.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(additions, id, serviceAgreementId, name, description, type, permissions, validFrom, validUntil, approvalId, metadata);
  }
