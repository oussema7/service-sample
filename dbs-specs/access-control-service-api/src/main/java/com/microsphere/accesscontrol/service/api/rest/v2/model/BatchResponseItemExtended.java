...
import com.microsphere.accesscontrol.service.api.rest.v2.model.BatchResponseItemExtendedAllOf;
...
public class BatchResponseItemExtended 
 {
  ...
  public enum StatusEnum {
    ...
    public BatchResponseItemExtended additions(Map<String, String> additions) {
        this.additions = additions;
        return this;
    }

    public BatchResponseItemExtended putAdditionsItem(String key, String additionsItem) {
    ...
    public BatchResponseItemExtended externalServiceAgreementId(String externalServiceAgreementId) {
    ...
    public BatchResponseItemExtended action(PresentationAction action) {
        this.action = action;
        return this;
    }
    ...
    public BatchResponseItemExtended resourceId(String resourceId) {
    ...
    public BatchResponseItemExtended status(StatusEnum status) {
        this.status = status;
        return this;
    }
    ...
    public BatchResponseItemExtended errors(List<String> errors) {
        this.errors = errors;
        return this;
    }

    public BatchResponseItemExtended addErrorsItem(String errorsItem) {
        if (this.errors == null) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        BatchResponseItemExtended batchResponseItemExtended = (BatchResponseItemExtended) o;
        return Objects.equals(this.additions, batchResponseItemExtended.additions) &&
                Objects.equals(this.externalServiceAgreementId, batchResponseItemExtended.externalServiceAgreementId) &&
                Objects.equals(this.action, batchResponseItemExtended.action) &&
                Objects.equals(this.resourceId, batchResponseItemExtended.resourceId) &&
                Objects.equals(this.status, batchResponseItemExtended.status) &&
                Objects.equals(this.errors, batchResponseItemExtended.errors);
    }
    ...
    public String toString() {
        ...
        sb.append("class BatchResponseItemExtended {\n");
