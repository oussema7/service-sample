 ...
 */
@JsonPropertyOrder({
  BatchResponseItemAllOf.JSON_PROPERTY_RESOURCE_ID,
  BatchResponseItemAllOf.JSON_PROPERTY_STATUS,
  BatchResponseItemAllOf.JSON_PROPERTY_ERRORS
})
...
public  class BatchResponseItemAllOf {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(resourceId, status, errors);
  }
