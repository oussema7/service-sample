 ...
 */
@JsonPropertyOrder({
  UserPermissionsSummaryGetResponseBodyAllOf.JSON_PROPERTY_RESOURCE,
  UserPermissionsSummaryGetResponseBodyAllOf.JSON_PROPERTY_FUNCTION,
  UserPermissionsSummaryGetResponseBodyAllOf.JSON_PROPERTY_PERMISSIONS
})
...
public  class UserPermissionsSummaryGetResponseBodyAllOf {
 ...
 @Size(min=1,max=32)  @ApiModelProperty(value = "Resource name")
  ...
  **/
  @javax.annotation.Nullable
 @Size(min=1,max=32)  @ApiModelProperty(value = "Business function name")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(resource, function, permissions);
  }
