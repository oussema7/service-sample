 ...
 */
@JsonPropertyOrder({
  RevokeIdentityAccessServiceRequest.JSON_PROPERTY_COMMENT,
  RevokeIdentityAccessServiceRequest.JSON_PROPERTY_ADDITIONS
})
...
public  class RevokeIdentityAccessServiceRequest {
  ...
  **/
  @NotNull
 @Size(min=1,max=255)  @ApiModelProperty(required = true, value = "A comment regarding the access revokation, commonly a reason to revoke access.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(comment, additions);
  }
