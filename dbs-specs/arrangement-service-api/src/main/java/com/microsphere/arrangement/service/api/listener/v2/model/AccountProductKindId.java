...
@JsonPropertyOrder({
  AccountProductKindId.JSON_PROPERTY_ID
})
...
public  class AccountProductKindId extends AdditionalProperties {
  public static final String JSON_PROPERTY_ID = "id";
  private Integer id;


  public AccountProductKindId id(Integer id) {
   ...
   /**
   * A unique identifier for an object that is generated and used Internally in DBS.
   * @return id
  **/
  @NotNull
  @ApiModelProperty(required = true, value = "A unique identifier for an object that is generated and used Internally in DBS.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AccountProductKindId accountProductKindId = (AccountProductKindId) o;
    return Objects.equals(this.id, accountProductKindId.id) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class AccountProductKindId {\n");
