...
import com.microsphere.arrangement.service.api.listener.v2.model.ExternalProductKindItem;
 ...
 */
@JsonPropertyOrder({
  ExternalProductItem.JSON_PROPERTY_EXTERNAL_ID,
  ExternalProductItem.JSON_PROPERTY_EXTERNAL_TYPE_ID,
  ExternalProductItem.JSON_PROPERTY_TYPE_NAME,
  ExternalProductItem.JSON_PROPERTY_PRODUCT_KIND
})
...
public  class ExternalProductItem extends AdditionalProperties {
  ...
  private ExternalProductKindItem productKind;


  public ExternalProductItem externalId(String externalId) {
 ...
 @Size(max=50)  @ApiModelProperty(value = "A unique identifier for the product that the arrangement applies to ")
  ...
  public ExternalProductItem externalTypeId(String externalTypeId) {
 ...
 @Size(max=50)  @ApiModelProperty(value = "The ID that is used by the Bank to identify the specific Product type - External reference to the product Type.")
  ...
  public ExternalProductItem typeName(String typeName) {
 ...
 @Size(max=50)  @ApiModelProperty(value = "The label/name that is used to label a specific product type.")
  ...
  public ExternalProductItem productKind(ExternalProductKindItem productKind) {
  ...
  **/
  ...
  public ExternalProductKindItem getProductKind() {
    return productKind;
  }


  public void setProductKind(ExternalProductKindItem productKind) {
    this.productKind = productKind;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ExternalProductItem externalProductItem = (ExternalProductItem) o;
    return Objects.equals(this.externalId, externalProductItem.externalId) &&
        Objects.equals(this.externalTypeId, externalProductItem.externalTypeId) &&
        Objects.equals(this.typeName, externalProductItem.typeName) &&
        Objects.equals(this.productKind, externalProductItem.productKind) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class ExternalProductItem {\n");
