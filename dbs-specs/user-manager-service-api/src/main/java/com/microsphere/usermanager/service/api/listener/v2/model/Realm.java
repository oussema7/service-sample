 ...
 */
@JsonPropertyOrder({
  Realm.JSON_PROPERTY_ID,
  Realm.JSON_PROPERTY_REALM_NAME,
  Realm.JSON_PROPERTY_ADDITIONS
})
...
public  class Realm {
  ...
  **/
  ...
  public Realm realmName(String realmName) {
 ...
 @Size(min=1,max=255)  @ApiModelProperty(required = true, value = "Realm name")
  ...
  public Realm additions(Map<String, String> additions) {
    
    this.additions = additions;
    return this;
  }

  public Realm putAdditionsItem(String key, String additionsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Realm realm = (Realm) o;
    return Objects.equals(this.id, realm.id) &&
        Objects.equals(this.realmName, realm.realmName) &&
        Objects.equals(this.additions, realm.additions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, realmName, additions);
  }
