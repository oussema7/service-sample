...
@JsonPropertyOrder({
  ...
  User.JSON_PROPERTY_LEGAL_ENTITY_ID,
  User.JSON_PROPERTY_FULL_NAME,
  User.JSON_PROPERTY_PREFERRED_LANGUAGE,
  User.JSON_PROPERTY_ADDITIONS
})
...
public  class User {
 ...
 @Pattern(regexp="^\\S(.*(\\S))?$") @Size(min=1,max=64)  @ApiModelProperty(required = true, value = "external Id of the user.")
  ...
  public User legalEntityId(String legalEntityId) {
   ...
   /**
   * Legal Entity Id of the user.
   * @return legalEntityId
  **/
  @NotNull
 @Pattern(regexp="^\\S(.*(\\S))?$") @Size(min=1,max=36)  @ApiModelProperty(required = true, value = "Legal Entity Id of the user.")
 ...
 @Size(min=2,max=8)  @ApiModelProperty(value = "User preferred language.")
  ...
  public User additions(Map<String, String> additions) {
    
    this.additions = additions;
    return this;
  }

  public User putAdditionsItem(String key, String additionsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.externalId, user.externalId) &&
        Objects.equals(this.legalEntityId, user.legalEntityId) &&
        Objects.equals(this.fullName, user.fullName) &&
        Objects.equals(this.preferredLanguage, user.preferredLanguage) &&
        Objects.equals(this.additions, user.additions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(externalId, legalEntityId, fullName, preferredLanguage, additions);
  }
