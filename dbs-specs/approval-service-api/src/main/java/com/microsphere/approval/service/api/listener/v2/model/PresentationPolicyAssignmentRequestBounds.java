 ...
 */
@JsonPropertyOrder({
  PresentationPolicyAssignmentRequestBounds.JSON_PROPERTY_POLICY_ID,
  PresentationPolicyAssignmentRequestBounds.JSON_PROPERTY_UPPER_BOUND,
  PresentationPolicyAssignmentRequestBounds.JSON_PROPERTY_ADDITIONS
})
...
public  class PresentationPolicyAssignmentRequestBounds {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(policyId, upperBound, additions);
  }
