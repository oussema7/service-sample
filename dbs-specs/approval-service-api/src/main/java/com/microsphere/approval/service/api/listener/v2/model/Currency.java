...
@JsonPropertyOrder({
  ...
  Currency.JSON_PROPERTY_ADDITIONS
})
...
public  class Currency {
  ...
  **/
  @NotNull
 @DecimalMin("-1.0E+18") @DecimalMax("1.0E+18")  @ApiModelProperty(required = true, value = "The amount in the specified currency")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amount, currencyCode, additions);
  }
