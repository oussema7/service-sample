...
public class PresentationPostFilterApprovalsRequest 
 {
    ...
    public PresentationPostFilterApprovalsRequest canApprove(Boolean canApprove) {
    ...
    public PresentationPostFilterApprovalsRequest canReject(Boolean canReject) {
    ...
    public PresentationPostFilterApprovalsRequest functions(List<String> functions) {
        this.functions = functions;
        return this;
    }

    public PresentationPostFilterApprovalsRequest addFunctionsItem(String functionsItem) {
    ...
    public PresentationPostFilterApprovalsRequest approvalIds(List<String> approvalIds) {
        this.approvalIds = approvalIds;
        return this;
    }

    public PresentationPostFilterApprovalsRequest addApprovalIdsItem(String approvalIdsItem) {
    ...
    public PresentationPostFilterApprovalsRequest userId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public PresentationPostFilterApprovalsRequest serviceAgreementId(String serviceAgreementId) {
    ...
    public PresentationPostFilterApprovalsRequest additions(Map<String, String> additions) {
        this.additions = additions;
        return this;
    }

    public PresentationPostFilterApprovalsRequest putAdditionsItem(String key, String additionsItem) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PresentationPostFilterApprovalsRequest presentationPostFilterApprovalsRequest = (PresentationPostFilterApprovalsRequest) o;
        return Objects.equals(this.canApprove, presentationPostFilterApprovalsRequest.canApprove) &&
                Objects.equals(this.canReject, presentationPostFilterApprovalsRequest.canReject) &&
                Objects.equals(this.functions, presentationPostFilterApprovalsRequest.functions) &&
                Objects.equals(this.approvalIds, presentationPostFilterApprovalsRequest.approvalIds) &&
                Objects.equals(this.userId, presentationPostFilterApprovalsRequest.userId) &&
                Objects.equals(this.serviceAgreementId, presentationPostFilterApprovalsRequest.serviceAgreementId) &&
                Objects.equals(this.additions, presentationPostFilterApprovalsRequest.additions);
    }
    ...
    public String toString() {
        ...
        sb.append("class PresentationPostFilterApprovalsRequest {\n");
