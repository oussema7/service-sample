...
public class PostApprovalRequest 
 {
    ...
    public PostApprovalRequest userId(String userId) {
        this.userId = userId;
        return this;
    }
    ...
    public PostApprovalRequest serviceAgreementId(String serviceAgreementId) {
    ...
    public PostApprovalRequest itemId(String itemId) {
        this.itemId = itemId;
        return this;
    }
    ...
    public PostApprovalRequest dataAccessItemId(String dataAccessItemId) {
    ...
    public PostApprovalRequest resource(String resource) {
    ...
    public PostApprovalRequest function(String function) {
    ...
    public PostApprovalRequest amountDetails(Currency amountDetails) {
    ...
    public PostApprovalRequest action(String action) {
        this.action = action;
        return this;
    }
    ...
    public PostApprovalRequest approved(Boolean approved) {
    ...
    public PostApprovalRequest confirmationDetails(ConfirmationDetails confirmationDetails) {
    ...
    public PostApprovalRequest additions(Map<String, String> additions) {
        this.additions = additions;
        return this;
    }

    public PostApprovalRequest putAdditionsItem(String key, String additionsItem) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        PostApprovalRequest postApprovalRequest = (PostApprovalRequest) o;
        return Objects.equals(this.userId, postApprovalRequest.userId) &&
                Objects.equals(this.serviceAgreementId, postApprovalRequest.serviceAgreementId) &&
                Objects.equals(this.itemId, postApprovalRequest.itemId) &&
                Objects.equals(this.dataAccessItemId, postApprovalRequest.dataAccessItemId) &&
                Objects.equals(this.resource, postApprovalRequest.resource) &&
                Objects.equals(this.function, postApprovalRequest.function) &&
                Objects.equals(this.amountDetails, postApprovalRequest.amountDetails) &&
                Objects.equals(this.action, postApprovalRequest.action) &&
                Objects.equals(this.approved, postApprovalRequest.approved) &&
                Objects.equals(this.confirmationDetails, postApprovalRequest.confirmationDetails) &&
                Objects.equals(this.additions, postApprovalRequest.additions);
    }
    ...
    public String toString() {
        ...
        sb.append("class PostApprovalRequest {\n");
