...
import com.microsphere.bank.common.client.api.client.resttemplate.auth.ApiKeyAuth;
import com.microsphere.bank.common.client.api.client.resttemplate.auth.Authentication;
import com.microsphere.bank.common.client.api.client.resttemplate.auth.HttpBasicAuth;
import com.microsphere.bank.common.client.api.client.resttemplate.auth.OAuth;
...
/**
 * ApiClient generated with the swagger code gen using the resttemplate library
 */
@Component
public class ApiClient implements ConfigurableApiClient<RestTemplate> {
    ...
    @Override
    public RestTemplate getConnectionObject() {
        return restTemplate;
    }
